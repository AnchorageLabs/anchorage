  ...
  return JSON.stringify(
    {
      ...
      constraints: [
        ...
        "Verify via shell_exec with the change's COVERING tests (use relevant_tests, then run just those test files) plus typecheck/build SCOPED to the package/module you changed (e.g. 'go build ./changed/pkg/', 'tsc --noEmit -p <that tsconfig>', 'mypy path/to/pkg') — never a whole-repo build or test suite.",
        ...(isRevision
          ? [
